...
export async function Header() {
  ...
  return (
    <header className="border-border/40 bg-background/95 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 flex justify-center items-center border-b backdrop-blur">
