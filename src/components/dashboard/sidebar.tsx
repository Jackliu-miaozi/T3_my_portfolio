...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white shadow-md dark:bg-gray-800">
      {/* 修改标题区域，添加返回主页按钮 */}
      <div className="relative flex h-20 flex-col items-center justify-center border-b">
        <h1 className="text-xl font-bold text-gray-800 dark:text-white">
          管理仪表盘
        </h1>
        <Link
          href="/"
          className="absolute bottom-2 flex items-center gap-1 text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
        >
